      ...
      {step === 1 ? (
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between p-3.5 bg-indigo-50/70 border border-indigo-100 rounded-xl">
            ...
            <span className="text-xs font-medium bg-white px-2.5 py-1 rounded-full text-brand-600 border border-brand-200">
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-500 font-mono">External Upload</span>
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all placeholder:text-slate-400"
            />
          </div>
          ...
          <div className="pt-2 flex justify-end gap-3 border-t border-slate-100">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold rounded-xl transition-all shadow-sm flex items-center gap-2 hover:shadow-glow"
            >
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="p-4 bg-amber-50/70 border border-amber-200/60 rounded-xl flex gap-3 text-amber-900">
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/70 space-y-2 text-xs text-slate-700">
            ...
            {submissionNote && (
              <div className="pt-2 border-t border-slate-200/60">
                <span className="text-slate-500 block mb-1">Attached Note:</span>
                <p className="italic text-slate-800 bg-white p-2 rounded border border-slate-100">
                  "{submissionNote}"
                </p>
              </div>
            )}
          ...
          <div className="pt-2 flex justify-between items-center border-t border-slate-100">
            <button
              ...
              disabled={loading}
              onClick={() => setStep(1)}
              className="px-3.5 py-2 text-sm font-semibold text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-xl transition-colors flex items-center gap-1.5"
            >
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-sm font-bold rounded-xl transition-all shadow-md hover:shadow-lg flex items-center gap-2"
              >
                {loading ? (
                  <span>Recording...</span>
                ) : (
