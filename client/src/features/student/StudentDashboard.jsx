    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
          ...
          <div className="text-xs text-slate-500 mt-1">
            {group ? (
              ...
              <Link to="/student/groups" className="text-brand-600 hover:underline font-bold">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            {assignments.slice(0, 3).map((a) => {
              ...
              return (
                <div
                  key={a.id}
                  className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-brand-300 transition-all"
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <a
                      ...
                      className="p-2 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-600 text-xs font-bold transition-colors flex items-center gap-1"
                    ...
                    {!isConfirmed ? (
                      <button
                        ...
                        className="px-3.5 py-2 bg-brand-600 hover:bg-brand-700 text-white rounded-xl text-xs font-bold transition-all shadow-2xs flex items-center gap-1.5"
                      >
                        <FileCheck className="w-3.5 h-3.5" />
                        <span>Confirm</span>
                      </button>
                    ) : (
                      <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-xl border border-emerald-200/80">
                        Submitted ✓
                      </span>
                    )}
                  </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-slate-900">Team Snapshot</h2>
            <Link
              to="/student/groups"
              className="text-xs font-bold text-brand-600 hover:text-brand-700 flex items-center gap-1"
            >
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs space-y-4">
            {group ? (
              <>
                ...
                <Link
                  to="/student/groups"
                  className="w-full py-2 bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 transition-colors block text-center"
                >
